...
const GENERATED_HEADER: &str = "# Generated by nexgen. DO NOT EDIT!";
...
fn generate_tree(
    ...
    insert_branch_index_file(&mut files, branch, &model_hoists, mode)?;
...
fn generate_tree_node(
    ...
    match node {
        ...
        ApiSpecNode::Branch(branch) => {
            insert_branch_index_file(files, branch, model_hoists, mode)?;
            for node in branch.children.values() {
                generate_tree_node(node, support, mode, model_hoists, files, warnings)?;
            }
            Ok(())
        }
    }
...
fn insert_branch_index_file(
    ...
    let export_names = branch_export_names(branch, model_hoists, mode);
